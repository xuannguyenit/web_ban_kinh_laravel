                    ...
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            ...
                            <div class="position-center">
                                <form role="form" action="{{URL::to('admin/category/update/'.$edit_value->category_id)}}" method="post">
                                    {{ csrf_field() }}
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea style="resize: none" rows="8" class="form-control" name="category_product_desc" id="ckeditor_edit_category" >{{$edit_value->category_desc}}</textarea>
                                </div>
